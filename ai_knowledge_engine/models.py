...
class DocumentModel(BaseModel):
    ...
    title_embedding = ListAttribute(of=NumberAttribute, default=None)
    content_embedding = ListAttribute(of=NumberAttribute, default=None)
...
class DocumentProcessEntityModel(BaseModel):
    ...
    logs = ListAttribute(of=MapAttribute, default=None)
...
class KnowledgeGraphMetadataModel(BaseModel):
    ...
    document_type = UnicodeAttribute()
    structured_data_views = ListAttribute(of=MapAttribute, default=None)
    structured_fields = ListAttribute(of=MapAttribute, default=None)
    unstructured_attributes = ListAttribute(of=MapAttribute, default=None)
    linkage_rules = ListAttribute(of=MapAttribute, default=None)
    merge_rule = MapAttribute(default=None)
...
class DataSourceModel(BaseModel):
    ...
    data_views = ListAttribute(of=MapAttribute, default=None)
    created_at = UTCDateTimeAttribute()
    updated_by = UnicodeAttribute()
    updated_at = UTCDateTimeAttribute()
